...
{
	/// <inheritdoc/>
	protected override IResourceLayout Create(ResourceLayoutDescriptor key) => ModuleManager.GetModule<RenderingModule>()!.Device.ResourceFactory.CreateResourceLayout(key);
}
